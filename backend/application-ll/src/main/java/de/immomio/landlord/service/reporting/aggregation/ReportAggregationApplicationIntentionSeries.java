 ...
 */
@Service(ReportChartConstants.AGGR_BEAN_APPLICATION_INTENTION_SERIES)
public class ReportAggregationApplicationIntentionSeries implements ReportAggregationInterface {

    private SeriesChartHandler seriesChartHandler;
    private ElasticsearchQueryHandler queryHandler;

    @Autowired
    public ReportAggregationApplicationIntentionSeries(
