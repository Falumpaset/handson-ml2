...
public class OpenApiDocConfig extends BaseOpenApiDocConfig {
    ...
    public static final String LANDLORD_GROUP = "immomio-landlord";
    public static final String CONTROLLER_PACKAGE = "de.immomio.controller";
    public static final String TITLE = "Immomio Landlord API";
    public static final String DESCRIPTION = "Immomio Landlord API Documentation";
