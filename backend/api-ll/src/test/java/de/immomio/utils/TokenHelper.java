...
public class TokenHelper {
    ...
    public static String tokenFor(String email) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        Map<String, Object> token = objectMapper.readValue(writer.toString(),
    ...
    private static PrivateKey loadPrivateKey(InputStream keyInputStream, String algorithm)
        ...
        String privKeyString = stringBuilder.toString()
