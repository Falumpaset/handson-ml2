package de.immomio.model.abstractrepository.customer.user.right;
...
public interface AbstractRightRepository<PS extends AbstractPermissionScheme> extends JpaRepository<PS, Long> {
