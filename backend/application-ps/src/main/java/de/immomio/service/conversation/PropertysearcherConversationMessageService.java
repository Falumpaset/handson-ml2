...
@Service
public class PropertysearcherConversationMessageService extends AbstractConversationMessageService<ConversationMessageRepository> {

    private PropertysearcherApplyReadToMessageService applyReadToMessageService;

    @Autowired
    public PropertysearcherConversationMessageService(
            ConversationMessageRepository conversationMessageRepository,
            PropertysearcherApplyReadToMessageService applyReadToMessageService
    ) {
    ...
    public List<ConversationMessageBean> getUnreadMessages(Conversation conversation) {
        List<ConversationMessage> messages = conversationMessageRepository.getUnreadMessages(conversation.getId(), ConversationMessageSender.LANDLORD);
    ...
    public Long countUnread() {
        return conversationMessageRepository.countUnreadForPs();
    }
